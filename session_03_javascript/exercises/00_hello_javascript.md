...
```
      ...
      let banKinh = 5;
      // TODO: Tính diện tích = PI * r^2
      let dienTich = `Diện tích = PI * r^2=${(PI * banKinh * banKinh).toLocaleString()}`;
      console.log(dienTich);
      // TODO: Tính chu vi = 2 * PI * r
      let chuVi = `Chu vi = 2 * PI * r=${(2 * PI * banKinh).toLocaleString()}`;
      // TODO: In kết quả ra console
      console.log(chuVi);
```
...
```
// TODO: Tạo mảng 5 món ăn yêu thích
let menu = ["Bún chả", "Cơm rang", "Thịt nướng", "Nem cuốn", "Phở"];
// 1. In ra món đầu tiên và cuối cùng
console.log(menu[0]);
console.log(menu[menu.length - 1]);
// 2. Thêm 1 món vào đầu
menu.unshift("Thịt bò");
// 3. Xóa món cuối cùng
menu.pop();
// 4. Duyệt mảng và in "Món i: ten mon"
for (let i = 0; i < menu.length; i++) {
console.log(`Món ${i + 1}: ${menu[i]}`);
}
// 5. Kiểm tra "Phở" có trong mảng không?
console.log(menu.includes("Phở"));
```
...
tuoi: 20,
nganh: "httt",
soThich: ["music", "dance", "eat"],
diaChi: { tinh: "Hà Nội", quan: "Đống Đa", duong: "Tây Sơn" },
};
// 1. In ra: "Tôi là [hoTen], [tuoi] tuổi, học ngành [nganh]"
console.log(
...
console.log("Sở thích đầu tiên:", hoSo.soThich[0]);
      ...
      // 3. In ra địa chỉ đầy đủ
      console.log(
        `Địa chỉ: ${hoSo.diaChi.tinh},${hoSo.diaChi.quan},${hoSo.diaChi.duong}`,
      );
      // 4. Thêm thuộc tính "email"
      hoSo.email = "vtlv@gmail.com";
      console.log("Email:", hoSo.email);
```
...
console.log("Max:", maxHaiSo(10, 20));
// 2. laNamNhuan(nam) → true nếu năm nhuận
// (chia hết cho 4, không chia hết cho 100, hoặc chia hết cho 400)
